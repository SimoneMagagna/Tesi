...
Questa sezione descrive nel dettaglio il personale sviluppo delle più importanti funzionalità dell'applicazione attraverso l'editor grafico e il linguaggio di \textit{scripting} C\# offerti dal \textit{framework}\ped{\hyperlink{fw}{G}} \textit{Unity}.
