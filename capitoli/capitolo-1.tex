...
\begin{itemize}
	\item \textbf{SAP:} sistema informativo aziendale per la gestione di tutti i processi dell’azienda: vendite, acquisti, gestione magazzino, contabilità eccetera. SAP supporta il sistema di gestione ERP, acronimo di \textit{Enterprise resource planning}, il quale integra tutti i processi di \textit{business} rilevanti in un'azienda come vendite, acquisti, gestione magazzino, contabilità eccetera.
...
\begin{figure}[ht]
	\begin{center}
		...
		\caption{Ambiti aziendali gestiti dal sistema ERP. Immagine tratta dal sito della compagnia di sviluppo software KNOWART: \url{http://www.knowarth.com/enterprise-resource-planning/}}
	\end{center}
\end{figure}
\FloatBarrier
...
\begin{figure}[ht]
	\begin{center}
		...
		\caption{Ciclo di sviluppo della Metodologia Agile. Immagine tratta dal sito informativo Quora: \url{https://www.quora.com/What-are-the-pros-and-cons-of-the-waterfall-and-agile-scrum-project-management-approach}}
	\end{center}
\end{figure}
\FloatBarrier
